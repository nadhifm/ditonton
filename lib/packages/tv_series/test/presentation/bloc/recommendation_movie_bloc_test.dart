...
void main() {
  late TvRecommendationBloc movieRecommendationBloc;
  late MockGetTvRecommendations mockGetTvRecommendations;

  setUp(() {
    mockGetTvRecommendations = MockGetTvRecommendations();
    movieRecommendationBloc = TvRecommendationBloc(mockGetTvRecommendations);
  });

  test('initial state should be empty', () {
    expect(movieRecommendationBloc.state, TvRecommendationEmpty());
  });
